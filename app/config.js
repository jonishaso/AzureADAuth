...
var creds = {
  // Required
  identityMetadata:
    'https://login.microsoftonline.com/ruizeantrader.onmicrosoft.com/.well-known/openid-configuration',
  ...
  clientID: 'fe267b2a-0e56-49f4-8b52-09d958194541',
  ...
  redirectUrl: 'http://10.0.0.213:3001/auth/openid/return',
  ...
  clientSecret: '5UJ8Nk/3sjavbnGJNQm6Orse4luPU5A/f7BI8h2MuZM=',
...
var destroySessionUrl =
  'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=http://10.0.0.213:3001'
...
var useMongoDBSessionStore = false

// If you want to use mongoDB, provide the uri here for the database.
var databaseUri = 'mongodb://localhost/OIDCStrategy'

// How long you want to keep session in mongoDB.
var mongoDBSessionMaxAge = 24 * 60 * 60 // 1 day (unit is second)
export { creds, resourceURL,destroySessionUrl }
